    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="http://sis.uhb.edu.sa/psp/hcs9prd/?&cmd=login&languageCd=ARA&" target="_blank">SIS</a></h3>
          </div>
        </div>
       ...
       <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-store-line"></i>
            <h3><a href="https://www.uhb.edu.sa/Pages/Home.aspx">UHB</a></h3>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="seniorProject.aspx"><asp:Localize ID="locSP" meta:resourceKey="locSP" Text="Seniors Projects" runat="server"></asp:Localize></a></h4>
