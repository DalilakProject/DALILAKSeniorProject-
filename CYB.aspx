<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CYB.aspx.cs" Inherits="seniorProject.CYB" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>
                    <asp:Localize ID="locSP1" Text="Cyber Security" runat="server" meta:resourcekey="locSP1Resource1"></asp:Localize>
                </h2>
                <ol>
                    <li><a href="home.aspx">
                    ...
                    <li>
                        <asp:Localize ID="locSP2" Text="CYB" runat="server" meta:resourcekey="locSP2Resource1"></asp:Localize>
                    </li>
                            <li><a href="StudyPlans/CYB.pdf" target="_blank">
    ...
    <div class="container">
            ...
            <div class="text-center">
                <h1 class="h2 mt-5"><asp:Localize ID="locCSE3" meta:resourceKey="locRCSE3" Text="Cyber Security" runat="server"></asp:Localize></h1>
            </div>
            <hr />
