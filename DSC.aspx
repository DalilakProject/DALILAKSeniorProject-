<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DSC.aspx.cs" Inherits="seniorProject.DSC" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>
                    <asp:Localize ID="locSP1" Text="Data Science" runat="server" meta:resourcekey="locSP1Resource1"></asp:Localize>
                </h2>
                <ol>
                    <li><a href="home.aspx" >
                    ...
                    <li>
                        <asp:Localize ID="locSP2" Text="DSC" runat="server" meta:resourcekey="locSP2Resource1"></asp:Localize>
                    </li>
                            <li><a href="StudyPlans/DSC.pdf" target="_blank">
    ...
    <div class="container">
            ...
            <div class="text-center">
                <h1 class="h2 mt-5"><asp:Localize ID="locCSE3" meta:resourceKey="locRCSE3" Text="Data Science" runat="server"></asp:Localize></h1>
            </div>
            <hr />
